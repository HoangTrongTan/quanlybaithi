  ...
  return (
    <div className={cx("wrapper")}>
      <div style={{ display: "flex", gap: "2em" }}>
        <Tabs items={tabs} tabPosition="right" onChange={handleTabChange} />
        <div className={cx("list-mon-khoa")} ref={drop}>
          {
            listMon.length === 0 && <NoData />
          }
          <Search setList={setListMon} link={`MonhocPhan/findByname/${Khoa.current}/`} renderNull={() => renderMon(Khoa.current)} />
